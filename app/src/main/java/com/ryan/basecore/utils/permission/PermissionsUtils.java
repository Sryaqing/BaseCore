package com.ryan.basecore.utils.permission;
...
public class PermissionsUtils {
    ...
    public void chekPermissions(Activity activity, String[] permissions, @NonNull IPermissionsResult permissionsResult) {
